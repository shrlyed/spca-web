...
include("include/connection.php");
    ...
    if (isset($_POST['edit'])) {
        ...
        if($result)
        {
            echo "<script>alert('Cat information has been updated!');window.location='list_of_cats.php';</script>";
            session_write_close();
        }
        ...
        $id = ($_GET["id_cat"]);
        $_SESSION['id_cat'] = $id;
        $query = "SELECT * FROM cat WHERE id_cat=".$id."";
        $result = mysqli_query($conn, $query);
        ...
        if (!count($data)) {
            echo "<script>alert('Data is not found in database');window.location='edit_Cat.php';</script>";
        }
    }
	...
	<div class="row ">
		<div class="col-md-6 pt-xl-5 pl-xl-4  grid-margin stretch-card mx-auto">
			<div class="card border border-secondary">
				<div class="card-body">
					<h4 class="card-title">Edit cat information</h4>
