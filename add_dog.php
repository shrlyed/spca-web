...
include("include/connection.php");
	...
	if(isset($_POST['add'])) {
		...
		//Process the image that is uploaded by the admin
		...
		$query = "INSERT INTO dog(image, name, age, gender, description) VALUES('$image', '$name', '$age', '$gender', '$description') ;";
		$result = mysqli_query($conn, $query);
		if(!$result){
			die ("Query error: ".mysqli_errno($conn).
				" - ".mysqli_error($conn));
		} else {
			echo "<script>alert('New dog has been added.');window.location='list_of_dogs.php';</script>";
		}
	}
	...
	<div class="row ">
		<div class="col-md-6 pt-xl-5 pl-xl-4  grid-margin stretch-card mx-auto">
			<div class="card border border-secondary">
				<div class="card-body">
					<h4 class="card-title">Add new dog</h4>
