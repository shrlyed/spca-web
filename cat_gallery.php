        ...
        <section>
            <main>
                <div class="card border border-dark d-grid">
                    <div class="card-body">
                        <form action="cat_gallery.php" method="POST">
                    ...
                    <section id="" class="team section-bg">
                        <div class="container" data-aos="fade-up">
                            <div class="row">
                                <form action="add_cat.php"><div align="right"></div></form>
                                    <div class="table-wrapper-scroll-y my-custom-scrollbar">
                                        <table class="table border border-dark" width="100%" id="myTable" >
											...
											if($valueToSearch != ''){
												$query = mysqli_query($conn, "SELECT * FROM cat WHERE name LIKE '".$valueToSearch."' OR id_cat LIKE '".$valueToSearch."' ");
											}else{
												$query = mysqli_query($conn, "SELECT * FROM cat");	
											}
											...
											?>
												<tr>
													<td><?php echo $num++; ?></td>
													<td> <img style = "width: 175px" src= "assets/img/cat/<?php echo $row['image'] ; ?>"></td>
