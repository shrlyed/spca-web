					...
					<div class="table-wrapper-scroll-y my-custom-scrollbar">
						<table class="table border border-dark" width="50%" >
							...
							while($row = mysqli_fetch_assoc($result)) { ?>
								<tr>
									<td><?php echo $num; ?></td>
									<td> <img style = "width: 50px" src= "assets/img/cat/<?php echo $row['image'] ; ?>"></td>
									...
									<td>
										<a href="edit_cat.php?id_cat=<?php echo $row['id_cat']; ?>"><button class="btn btn-primary">Edit</button></a>
										<a href="delete_cat.php?id_cat=<?php echo $row['id_cat']; ?>" onclick="return confirm('Are you sure to delete this?')"><button class="btn btn-danger">Delete</button></a>
									</td>
								</tr>
								<?php $num++;
								} ?>  
